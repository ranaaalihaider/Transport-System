...
<head>
    ...
    <title>Passenger Portal - HajjTransport</title>
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ route('passenger.bookings.index') }}" class="{{ request()->is('passenger/bookings*') ? 'active' : '' }}">
        ...
        <div style="padding: 20px; border-top: 1px solid var(--border);">
            <div style="margin-bottom: 12px; font-size: 14px; color: var(--text-muted); font-weight: 500;">
                <i class="fa-solid fa-user"></i> Passenger Profile
            </div>
        ...
        <header class="header">
            <div style="display: flex; align-items: center;">
                ...
                <div class="header-title">
                    @yield('header_title', 'Passenger Portal')
                </div>
            </div>
            <div class="header-actions">
                <span class="badge badge-primary">Passenger Portal: {{ auth()->user()->name }}</span>
            </div>
        </header>
